...
impl TextManager {
    ...
    pub fn set_window_size(&mut self, win: &TermWindow) {
        self.border_x_px = win.hborderpx as i32;
        self.border_y_px = win.vborderpx as i32;
        self.window_width = win.w as i32;
        self.window_height = win.h as i32;
    }
